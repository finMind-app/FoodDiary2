...
enum LocalizationKey: String, CaseIterable {
    ...
    private var englishStrings: [LocalizationKey: String] {
        [
            ...
            .setDailyCalorieTarget: "Set your daily calorie target",
            .exampleCalories: "e.g. 2200",
            // Onboarding
            .close: "Close",
            .skip: "Skip",
            .next: "Next",
            ...
            .customOptional: "Custom (optional)",
    ...
    private var russianStrings: [LocalizationKey: String] {
        [
            ...
            .noneLabel: "Нет",
            // Calorie goal editor
            .dailyCaloriesTitle: "Дневная норма калорий",
            .setDailyCalorieTarget: "Установите дневную норму калорий",
            .exampleCalories: "напр. 2200",
            // Onboarding
            .close: "Закрыть",
            .skip: "Пропустить",
            .next: "Далее",
            ...
            .heightCm: "Рост (см)",
            .weightKg: "Вес (кг)",
            .recommendedDailyCalories: "Рекомендуемые дневные калории",
            .recommendedLabel: "Рекомендовано",
            .customOptional: "Свой вариант (необязательно)",
            .summaryTitle: "Сводка",
    ...
    private var spanishStrings: [LocalizationKey: String] {
        [
            ...
            .setDailyCalorieTarget: "Define tu meta calórica diaria",
            .exampleCalories: "p. ej. 2200",
            // Onboarding
            .close: "Cerrar",
            .skip: "Omitir",
            .next: "Siguiente",
            ...
            .heightCm: "Altura (cm)",
            .weightKg: "Peso (kg)",
            .recommendedDailyCalories: "Calorías diarias recomendadas",
            .recommendedLabel: "Recomendado",
            .customOptional: "Personalizado (opcional)",
            ...
            .getRemindedAboutGoals: "Recibe recordatorios de tus metas y suivi",
            ...
            .exportYourDataOrResetApp: "Exporta tus données ou réinitialise l'app",
            .clearAllData: "Borrar todos los datos",
            .clearAll: "Borrar todo",
            .clearAllDataAlertTitle: "Borrar todos los datos",
            .clearAllDataAlertMessage: "Esto eliminará permanentemente tus données. Esta acción no se puede deshacer.",
            .version: "Versión",
            ...
            // Achievements (ES)
            .achFirstMealTitle: "Primera comida",
            .achFirstMealDetail: "Registra tu primera comida.",
            .achFiveMealsTitle: "Empezando",
            .achFiveMealsDetail: "Registra 5 comidas en total.",
            .achTwentyMealsTitle: "Entusiasta de las comidas",
            .achTwentyMealsDetail: "Registra 20 comidas en total.",
            .achHundredMealsTitle: "Maestro de comidas",
            .achHundredMealsDetail: "Registra 100 comidas en total.",
            .achPhotoEntryTitle: "Foto pro",
            .achPhotoEntryDetail: "Adjunta una foto a una comida.",
            .achHealthySnacksTitle: "Snack inteligente",
            .achHealthySnacksDetail: "Registra 10 snacks.",
            .achBreakfastEarlyTitle: "Madrugador",
            .achBreakfastEarlyDetail: "Registra un desayuno antes de las 8 AM.",
            .achDinnerLateTitle: "Ave nocturna",
            .achDinnerLateDetail: "Registra una cena después de las 21:00.",
            .achStreak3Title: "Racha de 3 días",
            .achStreak3Detail: "Registra comidas 3 días seguidos.",
            .achStreak7Title: "Racha de 7 días",
            .achStreak7Detail: "Registra comidas 7 días seguidos.",
            .achGoalDayTitle: "En objetivo",
            .achGoalDayDetail: "Alcanza tu meta calórica diaria.",
            .achGoalWeek4Title: "Constancia",
            .achGoalWeek4Detail: "Alcanza la meta 4 días en una semana.",
            .achProtein100Title: "Golpe de proteína",
            .achProtein100Detail: "Alcanza 100 g de proteína en un día.",
            .achVeggieDayTitle: "Día veggie",
            .achVeggieDayDetail: "Registra 5 productos distintos en un día.",
            .achWeek30MealsTitle: "Semana cargada",
            .achWeek30MealsDetail: "Registra 30 comidas en una semana.",
            .achMonth100MealsTitle: "Súper registrador",
            .achMonth100MealsDetail: "Registra 100 comidas en un mes.",
            // Calorie status labels
    ...
    private var frenchStrings: [LocalizationKey: String] {
        [
            ...
            .setDailyCalorieTarget: "Définissez votre objectif calorique quotidien",
            .exampleCalories: "ex. 2200",
            // Onboarding
            .close: "Fermer",
            .skip: "Ignorer",
            .next: "Suivant",
            ...
            .heightCm: "Taille (cm)",
            .weightKg: "Poids (kg)",
            .recommendedDailyCalories: "Calories quotidiennes recommandées",
            .recommendedLabel: "Recommandé",
            .customOptional: "Personnalisé (optionnel)",
            ...
            // Achievements (FR)
            .achFirstMealTitle: "Premier repas",
            .achFirstMealDetail: "Enregistrez votre tout premier repas.",
            .achFiveMealsTitle: "C'est parti",
            .achFiveMealsDetail: "Enregistrez 5 repas au total.",
            .achTwentyMealsTitle: "Passionné de repas",
            .achTwentyMealsDetail: "Enregistrez 20 repas au total.",
            .achHundredMealsTitle: "Maître des repas",
            .achHundredMealsDetail: "Enregistrez 100 repas au total.",
            .achPhotoEntryTitle: "Pro de la photo",
            .achPhotoEntryDetail: "Ajoutez une photo à un repas.",
            .achHealthySnacksTitle: "Snack malin",
            .achHealthySnacksDetail: "Enregistrez 10 collations.",
            .achBreakfastEarlyTitle: "Lève-tôt",
            .achBreakfastEarlyDetail: "Enregistrez un petit-déjeuner avant 8 h.",
            .achDinnerLateTitle: "Oiseau de nuit",
            .achDinnerLateDetail: "Enregistrez un dîner après 21 h.",
            .achStreak3Title: "Série de 3 jours",
            .achStreak3Detail: "Enregistrez des repas 3 jours d'affilée.",
            .achStreak7Title: "Série de 7 jours",
            .achStreak7Detail: "Enregistrez des repas 7 jours d'affilée.",
            .achGoalDayTitle: "Dans l'objectif",
            .achGoalDayDetail: "Atteignez votre objectif calorique quotidien.",
            .achGoalWeek4Title: "Constance",
            .achGoalWeek4Detail: "Atteignez l'objectif 4 jours dans la semaine.",
            .achProtein100Title: "Coup de protéine",
            .achProtein100Detail: "Atteignez 100 g de protéines en une journée.",
            .achVeggieDayTitle: "Journée veggie",
            .achVeggieDayDetail: "Enregistrez 5 produits différents en une journée.",
            .achWeek30MealsTitle: "Semaine chargée",
            .achWeek30MealsDetail: "Enregistrez 30 repas en une semaine.",
            .achMonth100MealsTitle: "Super enregistreur",
            .achMonth100MealsDetail: "Enregistrez 100 repas en un mois.",
            // Calorie status labels
