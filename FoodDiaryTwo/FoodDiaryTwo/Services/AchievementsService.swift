...
final class AchievementsService {
    ...
    private let catalogue: [Achievement] = [
        ...
        Achievement(id: "goal_week_4", title: LocalizationManager.shared.localizedString(.achGoalWeek4Title), detail: LocalizationManager.shared.localizedString(.achGoalWeek4Detail), icon: "dot.scope", colorHex: "#22C55E", target: 4),
